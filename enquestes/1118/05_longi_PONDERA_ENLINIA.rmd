...
dades_raking$PONDERA_ENLINIA <- dades_raking$PONDERA_ENLINIA / mean(dades_raking$PONDERA_ENLINIA)
```

```{r save .sav results}
## Guardem la matriu .sav ----------------------------------------
write_sav(dades_raking, file.path(DTA_FOLDER, "PONDERA_ENLINIA_longi_V2.sav"))
```
