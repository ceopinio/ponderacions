...
## Microdades original ---------------------------
dades <- CEOdata::CEOdata(reo = "1097", raw = TRUE) %>% 
  filter(ENQUESTA == 1 & MODE_ADMIN == 1)
...
write_sav(dades_raking, file.path(RUTA_OMNIBUS, "ponderacions/PONDERA_ENLINIA_Omnibus.sav"))
```